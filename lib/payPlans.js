...
const PAY_PLANS = {
  ...
  // TESTE A/B de preço — musica-only (SEM video/brinde) + 1 edicao inclusa.
  // Comportam-se como `musica` na entrega (nenhum flag includes_video).
  // TESTE DEFINITIVO (09/jul): control 34% vs p2990 (R$29,90) 33% vs p2900 (R$29,00) 33%. Ambos so musica, sem video.
  test2900:    { cents: 2900, name: 'Musica personalizada - Lembranca Cantada' }, // R$29,00 so musica
  test29:      { cents: 2990, name: 'Musica personalizada - Lembranca Cantada' }, // R$29,90 so musica (variante p2990)
  test37:      { cents: 3700, name: 'Musica personalizada - Lembranca Cantada' }, // teste encerrado (historico)
  test47:      { cents: 4700, name: 'Musica personalizada - Lembranca Cantada' }, // teste encerrado (historico)
  test67:      { cents: 6700, name: 'Musica personalizada - Lembranca Cantada' }, // teste encerrado (historico)
